    ...
    items: [
      {
        ...
        children: [
          ...
          { id: 'customer_payments', label: 'Customer Payment', path: '/sales/customer-payments', matchPaths: ['/sales/customer-payments', '/sales/customer-refunds'] },
...
export const sidebarRouteMap: { route: string; sidebarIdPath: string }[] = [
  ...
  { route: '/sales/customer-refunds', sidebarIdPath: 'ops.sales.customer_payments' },
  { route: '/sales/customer-refunds/:id', sidebarIdPath: 'ops.sales.customer_payments' },
